...
export class CareerArea extends Area
{
    ...
    setLines()
    {
        ...
        const careerEvents = [
            { title: 'HTML & CSS Training', subtitle: 'High School · 2016–2018' },
            { title: 'Video Editing', subtitle: 'YouTube Channel · 2020–2021' },
            { title: 'LASUSU Essay', subtitle: '1st Place Winner · 2021' },
            { title: 'IoT & Space STEM', subtitle: 'Intelsat Program · 2023' },
            { title: 'Website Manager', subtitle: 'Ovic Bookshop · 2023' },
            { title: 'CompTIA A+ & Tech', subtitle: 'IT Projects · 2025–2026' },
        ]

        const createCareerTexture = (title, subtitle) =>
        {
        ...
        const careerTextures = careerEvents.map(e => createCareerTexture(e.title, e.subtitle))
        let careerTextureIndex = 0
        ...
        for(const group of lineGroups)
        {
            ...
            line.texture = careerTextures[careerTextureIndex % careerTextures.length]
            careerTextureIndex++
